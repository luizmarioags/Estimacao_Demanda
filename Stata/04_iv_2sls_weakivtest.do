...
export delimited using "$TABLEDIR_STATA/stata_iv_results_weakivtest.csv", replace
export excel using "$TABLEDIR_STATA/stata_iv_results_weakivtest.xlsx", firstrow(variables) replace
save "$TABLEDIR_STATA/stata_iv_results_weakivtest.dta", replace

di as result "2SLS + weakivtest concluídos. Resultado salvo em $TABLEDIR_STATA/stata_iv_results_weakivtest.csv"
