...
export delimited using "$TABLEDIR_STATA/stata_ols_results.csv", replace
save "$TABLEDIR_STATA/stata_ols_results.dta", replace

di as result "MQO concluído. Resultado salvo em $TABLEDIR_STATA/stata_ols_results.csv"
